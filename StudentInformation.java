public class StudentInformation 
{
		 ...
		 public StudentInformation(int rollNo, String studentFirstName, String studentLastName, int age) {
		    ...
		    {
		        StudentInformation s1 = new  StudentInformation(11111, "Pankaj", "Kumar", 25);
		        StudentInformation s2 = new  StudentInformation(11111, "Pankaj", "Kumar", 25);
		        StudentInformation s3 = new  StudentInformation(22222, "Pankaj", "Kumar", 27);
		        StudentInformation s4 = new  StudentInformation(22222, "Pankaj", "Kumar", 27);
